...
void Population() 
{
  ...
  buttonWidth[1] = appWidth*(1.0/3.0)*(1.0/4.0); //widthDenominator count = 9 ... 1/9
  ...
  buttonWidth[2] = appWidth*(1.0/3.0)*(1.0/4.0); //widthDenominator count = 6 ... 1/6
  ...
  buttonWidth[3] = appWidth*(1.0/3.0)*(1.0/4.0); //widthDenominator count = 15 ... 1/15
  ...
  buttonWidth[4] = appWidth*(1.0/3.0)*(1.0/4.0); //widthDenominator count = 15 ... 1/15
  ...
  buttonWidth[6] = appWidth*(1.0/3.0)*(1.0/4.0); //widthDenominator count = 15 ... 1/15
